! function() {
    function n(n, t) {
        for (var e = new Array, o = 0; o < n.length; o++)
            if ("&" == n.charAt(o)) {
                var r = [3, 4, 5, 9],
                    a = 0;
                for (var c in r) {
...
0 == a && e.push(n.charAt(o))
    ...
    var h = ["https://aq.qq.com/cn2/manage/mbtoken/hijack_sec_js_report", "https://zyjc.sec.qq.com/dom", "https://aq.qq.com/cn2/manage/mbtoken/hijack_pv_report", "https://aq.qq.com/cn2/manage/mbtoken/hijack_xss_report", "https://aq.qq.com/cn2/manage/mbtoken/hijack_mv_js_report"],
        d = Math.random(),
        l = .01,
        f = !1;
    t(),
        function(n, t, e) {
            ...
            function k(n, t, e, o, r) {
                var a = n.getElementsByTagName(t),
                    c = C(a, e),
                    i = w(c, o),
                    m = C(i, r);
                return m
